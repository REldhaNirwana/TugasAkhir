...
if(isset($_SESSION["loggedin_penyewa"]) && $_SESSION["loggedin_penyewa"] === true){
    header("location: penyewa_index.php");
    exit;
}
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){      
                    ...
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
                            ...
                            $_SESSION["loggedin_penyewa"] = true;
                            $_SESSION["id"] = $id;
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                        ...
                        <!-- Nested Row within Card Body -->
                                <div class="p-5">
									...
									<p>Belum memiliki akun? <a href="register.php">Daftar sekarang</a>.</br>
									Kembali ke <a href="index.php">Landing</a>.</p>
									</form>
                                    <hr>
